namespace System.Web.Mvc
{
                                      ...
                                      IEnumerable<KeyValuePair<string, object>>, IEnumerable
    {
        ...
        public virtual System.Web.Mvc.ModelMetadata ModelMetadata
        {
            get
            {
                ...
                if ((this._modelMetadata == null) && (this._model != null))
                {
                    ...
                    {
                        modelAccessor = delegate { return this._model; };
                    }
                    this._modelMetadata = ModelMetadataProviders.Current.GetMetadataForType(modelAccessor,
                                                                                            this._model.GetType());
                }
        ...
        {
            get { return this._innerDictionary.IsReadOnly; }
        }
        ...
        #region Nested type: ViewDataEvaluator
        ...
        internal static class ViewDataEvaluator
        {
            ...
            private static ViewDataInfo GetPropertyValue(object container, string propertyName)
            {
                ...
                ViewDataInfo info2 = new ViewDataInfo(delegate { return descriptor.GetValue(container); });
            ...
            {
            <
                GetRightToLeftExpressions > d__2
                d__ = new < GetRightToLeftExpressions > d__2(-2);
                d__.<>
                3
        ...
        >
            d__2
        :
            IEnumerable<ViewDataDictionary.ViewDataEvaluator.ExpressionPair>
        ,
            IEnumerable
        ,
            IEnumerator<ViewDataDictionary.ViewDataEvaluator.ExpressionPair>
        ,
            IEnumerator
        ,
            IDisposable
        ...
        private
            ...
            __state;
            private
            ViewDataDictionary.ViewDataEvaluator.ExpressionPair<>
            2
            __current;
            public
            string  <>
            ...
            DebuggerHidden]
                public <
            GetRightToLeftExpressions > d__2(int <>
            1
            __state)
            {
                this.<>
        ...
        private
            ...
            ()
            {
                ...
                __state)
                {
                    ...
                    this.<>
                    2
                    __current = new ViewDataDictionary.ViewDataEvaluator.ExpressionPair(this.expression, string.Empty);
                    this.<>
                    1
                    __state = 1;
                    return true;
                    ...
                    this.<
                    lastDot > 5
                    __3 = this.expression.LastIndexOf('.');
                    this.<
                    subExpression > 5
                    __4 = this.expression;
                    this.<
                ...
                __3 > -1)
                {
                    this.<
                    subExpression > 5
                    __4 = this.expression.Substring(0, this. < lastDot > 5
                    __3)
                    ;
                    this.<
                    postExpression > 5
                    __5 = this.expression.Substring(this. < lastDot > 5
                    __3 + 1)
                    ;
                    this.<>
                    2
                    __current = new ViewDataDictionary.ViewDataEvaluator.ExpressionPair(this. < subExpression > 5
                    __4,
                    this.<
                    postExpression > 5
                    __5)
        ...
        [
            DebuggerHidden]
            IEnumerator < ViewDataDictionary.ViewDataEvaluator.ExpressionPair >
            IEnumerable<ViewDataDictionary.ViewDataEvaluator.ExpressionPair>.GetEnumerator()
            {
                ...
                {
                    d__ = new ViewDataDictionary.ViewDataEvaluator.<
                    GetRightToLeftExpressions > d__2(0);
                }
                d__.expression = this.<>
                3
                __expression;
            ...
            IEnumerable.GetEnumerator()
            {
                return
                    this.System.Collections.Generic.IEnumerable
                        <System.Web.Mvc.ViewDataDictionary.ViewDataEvaluator.ExpressionPair>.GetEnumerator();
            }
        ...
        [
            ...
            ViewDataDictionary.ViewDataEvaluator.ExpressionPair
            IEnumerator<ViewDataDictionary.ViewDataEvaluator.ExpressionPair>.Current
            {
            [
                DebuggerHidden]
                get
            ...
            #region Nested type: ExpressionPair
