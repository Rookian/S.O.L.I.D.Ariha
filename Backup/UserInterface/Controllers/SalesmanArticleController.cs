...
namespace UserInterface.Controllers
{
    public class SalesmanArticleController : Controller
    {
        ...
        public SalesmanArticleController()
            : this(SalesmanArticleRepositoryFactory.GetDefault(), SalesmanRepositoryFactory.GetDefault(), ArticleRepositoryFactory.GetDefault())
        {
