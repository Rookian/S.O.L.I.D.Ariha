...
namespace Infrastructure.DataAccess.Repositories.ConsumerProtection
{
        ...
        public IList<SalesmanArticleGroupedByMonthAndDescription> GetSalesmanArticleGroupedByMonthAndDescription()
        {
            ...
            return GetSession()
                ...
                .SetProjection(Projections.ProjectionList()
                                   ...
                                   .Add(Projections.Sum(Projections.SqlFunction(multiply, NHibernateUtil.Decimal, Projections.Property(amount), Projections.Property(cost))), cost)
                // GROUP BY
                                   .Add(Projections.GroupProperty(descriptionformat), description)
                                   .Add(Projections.SqlGroupProjection(formatedDateSql, formatedDateGroupBy, new[] { month }, new[] { NHibernateUtil.Int32 })))
